...
public class MainActivity extends AppCompatActivity {
    ...
    private Button btn1, btn2, btn3, btn4, btn5, btn6, btn7, btn8, btn9, btn0, btnP, btnM, btnX, btnD, btnR, btnC, btnDot, btnPercent, btnCE, btnDEL;
    private int a;
